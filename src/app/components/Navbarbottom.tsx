...
const Navbarbottom = () => {
  ...
  return (
      ...
      <div className='flex justify-between w-[70vw] mx-auto sm:py-1 py-5 '>
        ...
        <NavLink href="/contact" className={`block md:hidden ${(isActive) =>isActive ? 'text-[#007580] px-2.5 py-5 md:p-5 font-[500]' : ' text-[#636270] px-2.5 py-5 md:p-5 font-[500]'}`}>Contact</NavLink>
        <NavLink href="/faqs" className={`block md:hidden ${(isActive) =>isActive ? 'text-[#007580] px-2.5 py-5 md:p-5 font-[500]' : ' text-[#636270] px-2.5 py-5 md:p-5 font-[500]'}`}>Help</NavLink>
