...
const Ourproducts = () => {
  ...
  return (
    <div className='m-5 ml-0 flex flex-wrap   gap-x-9 gap-y-10 w-[120%]'>
      {carts.map((item) => {
        return <div key={item.id} className=''>
          <div className='product-image-with-iconsh-[255px] w-[255px] sm:h-[312px] sm:w-[312px] rounded-md relative'>
            ...
            <Link href = "/details"><div className=' flex justify-center h-[255px] w-[255px] sm:h-[312px] sm:w-[312px] items-center bg-[#F5F5F5]'>
