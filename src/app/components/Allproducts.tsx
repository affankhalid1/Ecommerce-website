...
const Allproducts = () => {
  ...
  return (
    <div>
      <div className='m-5 ml-0 flex flex-wrap   gap-x-9 gap-y-10 sm:gap-y-24 w-[120%]'>
      {carts.map((item) => {
        return <div key={item.id} className=''>
          <div className='product-image-with-iconsw-[180px] h-[180px] sm:w-[312px] sm:h-[312px] rounded-md relative'>
            ...
            <div className=' flex justify-center items-center w-[180px] h-[180px] sm:w-[312px] sm:h-[312px] bg-[#F5F5F5]'>
